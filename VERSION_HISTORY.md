...
### v1.2.0-with-backspace.html（最新版）
**发布日期：** 2026-01-07
**状态：** ✅ 稳定，推荐使用
...
| 功能 | v1.0.0 | v1.1.0 | v1.2.0 | Mobile v1.0.0 |
|------|--------|--------|--------|---------------|
| 基础计算 | ✅ | ✅ | ✅ | ✅ |
| 货币换算 | ✅ | ✅ | ✅ | ✅ |
| 千分符 | ❌ | ✅ | ✅ | ❌ |
...
| 光标动效 | ❌ | ❌ | ✅ | ❌ |
| 多语言 | ❌ | ✅ | ✅ | ❌ |
| 0按钮布局 | 占2格 | 占1格 | 占2格 | 占2格 |
| 适用平台 | PC | PC | PC | Mobile |
...
### 如果你要...
- **最佳交互体验** → v1.2.0-with-backspace.html ⭐ **推荐**
- **多语言 + 千分符** → v1.1.0-with-improvements.html
...
```bash
# 使用 v1.2.0（最新版本，交互最佳）
cp v1.2.0-with-backspace.html calculator-pc.html
...
├── v1.0.0-stable.html               # 原始稳定版
├── v1.1.0-with-improvements.html    # 改进版
├── v1.2.0-with-backspace.html       # 最新版（推荐）⭐
